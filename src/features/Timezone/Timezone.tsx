...
export function Timezone() {
  ...
  const columns = columnsConfig({
    closeDialog,
    openDialog,
    handleDelete: handleDeleteTimezone,
    isLoadingDelete,
  });
  ...
  return (
    <MainContainer>
      <AppBar>
        <HeaderTitle>Fusos Horários</HeaderTitle>
      </AppBar>
      <Box
        sx={{
          width: "1400px",
            ...
            <div style={{ height: "100%", width: "100%" }}>
              <DataGrid
                ...
                onRowDoubleClick={(params) => {
                  handleEditTimezone(params.id as string);
                }}
                initialState={{
                  pagination: {
      ...
      <TimezoneDialog open={!!timezoneId} onClose={handleClose} />
      <TimezoneDialog open={!!isToAddTimezone} onClose={handleClose} />
    </MainContainer>
  );
}
