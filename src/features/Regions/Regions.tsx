...
export function Regions() {
  ...
  return (
    <MainContainer>
      <AppBar>
        <HeaderTitle>Regiões</HeaderTitle>
      </AppBar>
      <Box
        sx={{
          width: "1400px",
            ...
            <div style={{ height: "100%", width: "100%" }}>
              <DataGrid
                ...
                onRowDoubleClick={(params) => {
                  handleEditRegion(params.id as string);
                }}
                initialState={{
                  pagination: {
      ...
      <RegionsDialog open={!!regionId} onClose={handleClose} />
      <RegionsDialog open={!!isToAddRegion} onClose={handleClose} />
    </MainContainer>
  );
}
