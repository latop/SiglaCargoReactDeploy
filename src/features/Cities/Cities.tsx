...
import { CitiesFilterBar } from "@/components/CitiesFilterBar";
...
export function Cities() {
  ...
  return (
    <MainContainer>
            ...
            <div style={{ height: "100%", width: "100%" }}>
              <DataGrid
                ...
                onRowDoubleClick={(params) => {
                  handleEditCity(params.id as string);
                }}
                initialState={{
                  pagination: {
      ...
      <CitiesDialog open={!!cityId} onClose={handleClose} />
      <CitiesDialog open={!!isToAddCity} onClose={handleClose} />
    </MainContainer>
  );
}
