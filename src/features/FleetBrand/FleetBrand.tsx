...
import { useFleetBrand } from "./useFleetBrand";
import { columnsConfig } from "./configColumn";
import { FleetBrandDialog } from "@/components/FleetBrandDialog";
...
export function FleetBrand() {
  ...
  const columns = columnsConfig({
    closeDialog,
    openDialog,
    handleDelete: handleDeleteFleetBrand,
    isLoadingDelete,
  });
  ...
  return (
    <MainContainer>
      <AppBar>
        <HeaderTitle>Marcas de Frota</HeaderTitle>
      </AppBar>
      <Box
        sx={{
          width: "1400px",
            ...
            <div style={{ height: "100%", width: "100%" }}>
              <DataGrid
                ...
                onRowDoubleClick={(params) => {
                  handleEditFleetBrand(params.id as string);
                }}
                initialState={{
                  pagination: {
      ...
      <FleetBrandDialog open={!!fleetBrandId} onClose={handleClose} />
      <FleetBrandDialog open={!!isToAddFleetBrand} onClose={handleClose} />
    </MainContainer>
  );
}
