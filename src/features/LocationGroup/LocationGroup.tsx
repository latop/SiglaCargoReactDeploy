...
import { useLocationGroup } from "./useLocationGroup";
import { columnsConfig } from "./columnsConfig";
import { LocationGroupsDialog } from "@/components/LocationGroupsDialog";
export function LocationGroup() {
  ...
  return (
    <MainContainer>
      <AppBar>
        <HeaderTitle>Grupos de Localização</HeaderTitle>
      </AppBar>
      <Box
        sx={{
          width: "1400px",
            ...
            <div style={{ height: "100%", width: "100%" }}>
              <DataGrid
                ...
                onRowDoubleClick={(params) => {
                  handleEditLocationGroup(params.id as string);
                }}
                initialState={{
                  pagination: {
      ...
      <LocationGroupsDialog open={!!locationGroupId} onClose={handleClose} />
      <LocationGroupsDialog
        open={!!isToAddLocationGroup}
        onClose={handleClose}
      />
    </MainContainer>
  );
