...
export function Countries() {
  ...
  return (
    <MainContainer>
      <AppBar>
        <HeaderTitle>Países</HeaderTitle>
      </AppBar>
      <Box
        sx={{
          width: "1400px",
            ...
            <div style={{ height: "100%", width: "100%" }}>
              <DataGrid
                ...
                onRowDoubleClick={(params) => {
                  handleEditCountry(params.id as string);
                }}
                initialState={{
                  pagination: {
      ...
      <CountriesDialog open={!!countryId} onClose={handleClose} />
      <CountriesDialog open={!!isToAddCountry} onClose={handleClose} />
    </MainContainer>
  );
}
