...
import { useTripType } from "./useTripType";
import { TripTypeDialog } from "@/components/TripTypeDialog/TripTypeDialog";
...
export function TripType() {
  ...
  return (
    <MainContainer>
      <AppBar>
        <HeaderTitle>Tipos de Viagem</HeaderTitle>
      </AppBar>
      <Box
        sx={{
          width: "1400px",
            ...
            <div style={{ height: "100%", width: "100%" }}>
              <DataGrid
                ...
                onRowDoubleClick={(params) => {
                  handleEditTripType(params.id as string);
                }}
                initialState={{
                  pagination: {
      ...
      <TripTypeDialog open={!!tripTypeId} onClose={handleClose} />
      <TripTypeDialog open={!!isToAddTripType} onClose={handleClose} />
    </MainContainer>
  );
}
